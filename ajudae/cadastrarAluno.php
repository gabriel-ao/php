            ...
            <div class="col-8 col-12-medium">
              <header class="major">
                <form  action="inserirAluno.php" method="POST">
                  Nome Completo:<br>
                  <div>
                    <input class="form-control p-3 mb-2 bg-white text-dark" type="text" name="Nome"><br>
                  </div>

                  R.A Aluno:<br>
                  <div>
                    <input class="form-control p-3 mb-2 bg-white text-dark" type="text" name="RA"> <br>
                  </div>
                 
                  Curso:<br>
                  <div>
                    <input  class="form-control p-3 mb-2 bg-white text-dark" type="text" name="Curso" ><br>
                  </div>

                  Semestre cursando:
                  <div>
                    <input class="form-control p-3 mb-2 bg-white text-dark"  type="text" name="Semestre"> <br>
                  </div>
