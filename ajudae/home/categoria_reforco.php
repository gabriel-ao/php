...
<body>
    <div id="site">
        ...
        <div id="busca">
         ...
         <a class="dropdown-item active " href="categoria_reforco.php">Reforço</a>
        ...
        <div class="card-deck">
            <div class="container-fluid">
                <div class="row text-center">
                    ...
                    <?php 
                    $sql_pedido = mysqli_query($link, utf8_decode("SELECT titulo, descricao, ID_pedido FROM pedido WHERE categoria = 'reforço' ORDER BY `ID_pedido`"));
