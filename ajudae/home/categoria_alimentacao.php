...
<body>
    <div id="site">
       ...
       <h4><p style="text-align:center;">Categorias</p></h4>
         ...
         <a class="dropdown-item active" href="categoria_alimentacao.php">Alimentaçao</a>
        ...
        <div class="card-deck">
            <div class="container-fluid">
                <div class="row text-center">
                    ...
                    <?php 
                    $sql_pedido = mysqli_query($link, utf8_decode("SELECT titulo, descricao, ID_pedido FROM pedido WHERE categoria = 'Alimentação' ORDER BY `ID_pedido`"));
