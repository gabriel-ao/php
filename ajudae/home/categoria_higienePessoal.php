...
<body>
    <div id="site">
        ...
        <div id="busca">
         ...
         <a class="dropdown-item active " href="categoria_higienePessoal.php">Higiene pessoal</a>
        ...
        <div class="card-deck">
            <div class="container-fluid">
                <div class="row text-center">
                    ...
                    <?php 
                    $sql_pedido = mysqli_query($link, "SELECT titulo, descricao, ID_pedido FROM pedido WHERE categoria = 'Higiene pessoal'ORDER BY `ID_pedido`");
