...
<body>
    <div id="site">
        ...
        <div id="busca">
         ...
         <a class="dropdown-item active " href="categoria_vestuario.php">Vestuários</a>
        ...
        <div class="card-deck">
            <div class="container-fluid">
                <div class="row text-center">
                    ...
                    <?php 
                    $sql_pedido = mysqli_query($link, utf8_decode("SELECT titulo, descricao, ID_pedido FROM pedido WHERE categoria = 'vestuario' ORDER BY `ID_pedido`"));
