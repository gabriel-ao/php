    ...
    <div id="facaSeuPedido">
      ...
      <div class="card-deck">
       <div class="container-fluid">
        ...
        $sql_pedido = mysqli_query($link, "SELECT titulo, descricao, ID_pedido, status_pedido FROM pedido WHERE FK_doador_usuario = '$ID' AND status_pedido != 'finalizado'  ");
        while($resultado_pedido = mysqli_fetch_array($sql_pedido)){
            ...
            $status = $resultado_pedido['status_pedido'];
              ...
              <center>
                ...
                <a style="width: 70%" class="btn btn-primary" href="../CRUD/recusar_pedido.php?ID_pedido='.$resultado_pedido['ID_pedido'].'" >cancelar ajuda</a>
                </div>
              </center>
              </div>
              </div>
